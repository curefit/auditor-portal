...
from dates d
left join (
select membership_key, business_line, membership_created_date, pack_start_date, pack_end_date, is_enterprise, amount_paid, pack_name, user_id, cancellation_date
from dwh_fitness_mart.membership_dim 
where 1=1
and UPPER(business_line) not like '%PT%' -- users of PT are counted in ELITE/PRO memberships
